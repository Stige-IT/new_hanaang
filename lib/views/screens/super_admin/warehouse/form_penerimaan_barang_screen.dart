...
class FormPenerimaanBarang extends ConsumerStatefulWidget {
  const FormPenerimaanBarang({super.key});

  @override
  ConsumerState createState() => _FormCreatePenerimaanBarangState();
}

class _FormCreatePenerimaanBarangState
    extends ConsumerState<FormPenerimaanBarang> {
